...
import Star_title from './component/star_title/star_title';
import Paragraphe from './component/paragraphe/prgf';
import Card from './component/Card/card';
import Title from './component/title/title';
import Logos from './component/logos/logos';
import FeatureCard from './component/stats/stats';
import City from './component/Card_City/City';
import Footer from './component/footer/footer';
import './App.css';
/*
*  <City img="https://www.docplanner.com/images/warsaw.png" name="Warsaw" />
            <City img="https://www.docplanner.com/images/barcelona.png" name="Barcelona" />
            <City img="https://www.docplanner.com/images/istanbul.png" name="Istanbul" />
            <City img="https://www.docplanner.com/images/rome.png" name="Rome" />
            <City img="https://www.docplanner.com/images/mexico-city.png" name="Mexico City" />
            <City img="https://www.docplanner.com/images/curitiba.png" name="Curitiba" />
*
* */
    ...
    <div >
      ...
      <div className='feature' style={{overflow: 'hidden'}}>
        <div style={{display: 'flex', flexDirection: 'column',width: '500px', marginTop: '30px', marginRight: '30px', position: 'relative'}}>
          ...
          <img style={{position:'absolute', bottom: "-190px", right: "170px"}} src='https://lh3.googleusercontent.com/-Z5f83lXngic/XoIQl626RLI/AAAAAAAACPQ/QTO11XTE9K0x3HwKzBuBCShKftpJVmNFACK8BGAsYHg/s0/2020-03-30.png' alt='star' />
        </div>
        
        <div style={{display: 'flex', flexWrap:'wrap', width:'540px'}}>
          <div style={{marginTop:'25px'}}>
            <FeatureCard icon="https://www.docplanner.com/img/flag.png" title="Leader in 10 countries" description="Poland, Turkey, Spain, Italy, Czech Republic, Mexico, Brazil, Colombia, Argentina and Chile"/>
            <FeatureCard icon="https://www.docplanner.com/img/visits.png" title="1.5 million appointments" description="booked last month"/>
          </div>
          <div>
            <FeatureCard icon="https://www.docplanner.com/img/patients.png" title="30 million unique patients" description="visit us every month"/>
            <FeatureCard icon="https://www.docplanner.com/img/doctors.png" title="2 million active doctors" description="trust in our solutions"/>
          </div>    
        </div>
      
      </div>
      <div style={{display:'flex', flexDirection:'column', textAlign: 'center', width:'458px', height: '150px', margin: '70px 100px 100px 100px', paddingLeft: '30%', paddingRight: '30%'}}>
        <Title>
      ...
      <div className="City_Card">
          ...
          {CardItems.map((item)=> <City image={item.img} name={item.title} /> )}
